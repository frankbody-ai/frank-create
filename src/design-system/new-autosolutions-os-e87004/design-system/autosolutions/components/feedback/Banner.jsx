...
const ICONS = { info: 'information-circle', success: 'check-circle', warning: 'exclamation-triangle', critical: 'exclamation-circle', ai: 'sparkles' };

export function Banner({ title, tone = 'info', children, action, secondaryAction, onDismiss, icon, className = '', style, ...rest }) {
  return (
