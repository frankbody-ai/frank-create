...
export const fallbackConfig: FrankConfig = {
  ...
  models: [
    ...
    },
    {
      ...
      allowed_aspect_ratios: ["1:1", "3:2", "2:3", "4:3", "3:4", "16:9", "9:16", "21:9"],
      // No resolution tier upstream — gpt-image-2 sizes via aspect ratio + quality.
      allowed_image_sizes: [],
    ...
    },
    {
      ...
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16", "3:2", "2:3", "21:9"],
      // FLUX.2 bills per megapixel and exposes no resolution tier.
      allowed_image_sizes: [],
    ...
    },
    {
      ...
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["21:9", "16:9", "3:2", "4:3", "1:1", "3:4", "2:3", "9:16"],
      allowed_image_sizes: ["1K", "2K", "4K"],
      reference_image_limit: 10,
      max_count: 4,
      cost_label: "premium",
    ...
    },
    {
      ...
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:2", "16:9", "4:5", "2:3", "9:16"],
    ...
    },
    {
      ...
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16", "3:2", "2:3"],
      // No resolution tier upstream, and a single reference image.
      allowed_image_sizes: [],
      reference_image_limit: 1,
      max_count: 4,
      cost_label: "premium",
    ...
    },
    {
      ...
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16", "3:2", "2:3", "1:2", "2:1"],
      allowed_image_sizes: ["1K", "2K"],
    ...
    },
    {
      ...
      badge: "4K",
      max_resolution_label: "4K",
      description: "ByteDance Seedance 2.0 via OpenRouter — native audio, 480p → 4K, 3–15s, first/last frame plus reference images. Billed per output second by resolution.",
      capabilities: { generation: true, edit: false, masked_edit: false, video: true },
