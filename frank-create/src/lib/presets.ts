...
export const fallbackConfig: FrankConfig = {
  ...
  models: [
    ...
    },
    {
      ...
      badge: "4K",
      max_resolution_label: "4K",
      description: "Nano Banana 2 (Gemini 3.1 Flash Image) via OpenRouter — 1K / 2K / 4K, extended aspect enum (incl. 1:4, 4:1, 8:1), up to 14 refs.",
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
    ...
    },
    {
      ...
      badge: "4K",
      max_resolution_label: "4K",
      description: "OpenAI gpt-image-2 via OpenRouter — full aspect enum plus pixel presets up to 4K (3840x2160). Sizes above 2560x1440 are experimental.",
