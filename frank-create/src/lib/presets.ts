...
export const fallbackConfig: FrankConfig = {
  ...
  models: [
    ...
    },
    {
      ...
      allowed_image_sizes: [],
      allowed_durations: [3, 5, 7, 10, 12, 15],
    ...
    },
    {
      ...
      badge: "1080p",
      max_resolution_label: "1080p",
      description: "Alibaba Wan 2.7 via OpenRouter — first/last frame control with synchronized audio. 2–15s at 720p / 1080p, explicit aspect ratios.",
      capabilities: { generation: true, edit: false, masked_edit: false, video: true },
