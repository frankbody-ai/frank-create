...
export const fallbackConfig: FrankConfig = {
  ...
  models: [
    ...
    },
    {
      ...
      badge: "4K",
      max_resolution_label: "4K",
      description: "High-quality Gemini image generation/editing. Supports 1K, 2K, 4K outputs.",
    ...
    },
    {
      ...
      badge: "4K",
      max_resolution_label: "4K",
      description: "Fast Gemini image generation/editing. Supports 1K, 2K, 4K outputs.",
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
      allowed_image_sizes: ["1K", "2K", "4K"],
      reference_image_limit: 14,
    ...
    },
    {
      id: "reve-2",
      label: "Reve 2.0",
      short_label: "Reve 2.0",
      provider: "replicate",
      provider_model: "reve/reve-2",
      status: "disabled",
      badge: "Soon",
      max_resolution_label: "Soon",
      description: "Coming soon — waiting on Replicate router.",
      capabilities: { generation: true, edit: false, masked_edit: false, video: false },
    ...
    },
    {
      ...
      provider: "replicate",
      provider_model: "xai/grok-imagine",
      status: "disabled",
      badge: "Soon",
      max_resolution_label: "Soon",
      description: "Coming soon — waiting on Replicate router.",
    ...
    },
    {
      id: "ideogram-4",
      label: "Ideogram 4.0",
      short_label: "Ideogram 4",
      provider: "replicate",
      provider_model: "ideogram-ai/ideogram-v4",
      status: "disabled",
      badge: "Soon",
      max_resolution_label: "Soon",
      description: "Coming soon — waiting on Replicate router.",
